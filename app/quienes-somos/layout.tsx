...
export const metadata: Metadata = {
  ...
  description: "Conoce a Dictaminemos: 15+ años de experiencia en avalúos y dictámenes. Fundada en 2023 por expertos certificados. Dr. Abel Escobar y Dr. Andrés García, profesionales RNA especializados.",
  keywords: [
    ...
    "peritos certificados RNA"
  ],
  openGraph: {
    title: "Quiénes Somos - Nuestra Historia y Experiencia | Dictaminemos",
    description: "Conoce a Dictaminemos: 15+ años de experiencia en avalúos y dictámenes periciales en Medellín.",
